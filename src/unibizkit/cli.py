  ...
  uni-biz-kit --task validate models/my-app
    ...
    def _handle_generate_command(self, args):
        ...
        if not args.skip_backend:
            ...
            self._generate_bin_scripts(bin_dir)
    ...
    def _generate_bin_scripts(self, bin_dir):
        """Generate operational scripts in bin/."""
        venv_check = """\
import sys
from pathlib import Path
...
"""
        ...
        create_script = bin_dir / "dev-supabase-create.py"
...
""")
        ...
        remove_script = bin_dir / "dev-supabase-remove.py"
        with open(remove_script, 'w', encoding='utf-8') as f:
            f.write("""\
#!/usr/bin/python3
...
""")
        ...
        reset_script = bin_dir / "dev-supabase-reset-schema-and-data.py"
        with open(reset_script, 'w', encoding='utf-8') as f:
            f.write("""\
#!/usr/bin/python3
