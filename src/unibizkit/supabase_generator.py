...
class SupabaseGenerator:
    ...
    def generate_supabase_config(self) -> str:
        """
        Generate a supabase/config.toml snippet for local development with SMTP settings.
        """
        ...
        return f"""# Supabase local development configuration
# Generated by UniBizKit - apply these settings to your supabase/config.toml
# or use as a reference for self-hosted Supabase configuration.
#
# To apply for local dev: copy/merge the sections below into your supabase/config.toml
# then restart: supabase stop && supabase start

[auth]
site_url = "{base_url}"
# Allow new users to sign up via the registration form
enable_signup = {enable_signup}

[auth.email]
# Require email confirmation before login is allowed
enable_confirmations = true
secure_email_change_enabled = true

[auth.smtp]
# Mock SMTP server for local development (run: python dev_smtp_mock.py)
enabled = true
host = "{smtp_host}"
port = {smtp_port}
user = "{smtp_user}"
