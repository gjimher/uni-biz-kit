...
* **Relationships** — to-one and to-many (join tables), `part_of` ownership hierarchies vs. loose `related_to` references, and `prefill` fields that copy values from a related record → [Backend.md](Backend.md#field-types)
