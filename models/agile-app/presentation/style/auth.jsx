// ---------------------------------------------------------------------------
// Agile Kit look & feel for the generated auth pages (signin, forgot/set/
      ...
      <main style={{ display: 'flex', justifyContent: 'center', padding: '80px 16px' }}>
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 20 }}>
            ...
            <span style={{ fontWeight: 800, fontSize: 22 }}>Agile Kit</span>
          </div>
...
export function Message({ kind, children }) {
  const colors = kind === 'error'
    ? { color: '#ae2a19', background: '#ffecea' }
    : { color: '#216e4e', background: '#dcfff1' };
  return (
...
export function SubmitButton({ disabled, children }) {
  return (
    <button type="submit" disabled={disabled} style={{
      ...
      background: disabled ? '#c1c7d0' : ACCENT, color: '#fff',
