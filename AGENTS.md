...
* It’s enough to run `test_ecommerce_backend` to verify that SQL generation works, and `test_ecommerce_frontend` for JavaScript generation. Both clean and regenerate everything before checking the SQL or the JS.
